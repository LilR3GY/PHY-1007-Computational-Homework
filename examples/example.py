...
#                                 Circuit E
    wires_E = [
        ...
        Wire(start=(50, 60), stop=(50, 65), current=Current(x=0, y=1), voltage=1.5),
        Wire(start=(50, 65), stop=(15, 65), current=Current(x=-1, y=0), voltage=1.5),
        Wire(start=(15, 65), stop=(15, 40), current=Current(x=0, y=-1), voltage=1.5),
        Wire(start=(15, 40), stop=(15, 15), current=Current(x=0, y=-1), voltage=-1.5),
        Wire(start=(15, 15), stop=(50, 15), current=Current(x=1, y=0), voltage=-1.5),
        Wire(start=(50, 15), stop=(50, 20), current=Current(x=0, y=1), voltage=-1.5),
